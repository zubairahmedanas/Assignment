def kilograms_to_pound_and_vicevers(numb):
    ...
    print("result of kilogram is :", kilogram_to_pound)

    pound_to_kilo = numb * 0.453592
    print("result of pound is :", pound_to_kilo)
...
def miligram_to_ounce_and_vicevers(numb):
    ...
    print("result of miligram is :", miligram_to_ounce)

    ounce_to_miligram = numb * 28349.5


    print("result of ounce is :", ounce_to_miligram)
